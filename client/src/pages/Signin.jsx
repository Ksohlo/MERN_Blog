      ...
      <div className='flex flex-col md:flex-row p-3 max-w-3xl mx-auto md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className='text-sm mt-5'>
            This is a demo project and you can sign in with your email or wih google
          </p>
        </div>
          ...
          <form className='flex flex-col gap-4'>
            <div>
              <div>
                ...
                <TextInput type='email' placeholder='usermail@mail.com' id='email' onChange={handleChange} />
              </div>
              ...
              <div>
                ...
                <Button gradientDuoTone="purpleToPink" type='submit' disabled={loading} className='mx-auto mt-3 w-full' onClick={handleSubmit}>
                  {
                    loading ? 
                    <>
                      <Spinner size="sm" />
